...
function button_custom_img_delete($post_id) {
...
function art_term_production_fields( $loop, $variation_data, $variation ) {
   woocommerce_wp_text_input( array(
      'id'                => '_term_prod_var[' . $variation->ID . ']',
      'label'             => 'Quality',
      'description'       => 'Terms',
      'desc_tip'          => 'true',
...
function load_variation_settings_fields( $variations ) {
   ...
   if ( isset( $variations_time ) && ! empty( $variations_time ) ) {
      ...
      $variations['_term_prod_var'] .= '<span>term </span>';
      $variations['_term_prod_var'] .= get_post_meta( $variations['variation_id'], '_term_prod_var', true ) . ' days';
